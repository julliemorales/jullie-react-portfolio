import Delaunay from 'delaunay/lib/delaunay';

function runDelaunay(canvas) {
    ...
    var lineWidth = 1;
    var linkChance = 75; // chance per frame of link higher = smaller chance
    var linkLengthMin = 5; // min linked vertices
    var linkLengthMax = 7; // max linked vertices
    var linkOpacity = 0.25; // number between 0 & 1
    var linkFade = 90; // link fade-out frames
    var linkSpeed = 1; // distance a link travels in 1 frame
    var glareAngle = -60;
    ...
    function init() {
        ...
        if ('ontouchstart' in document.documentElement && window.DeviceOrientationEvent) {
            ...
            window.addEventListener(
                ...
                function (e) {
                    mouse.x =
                        canvas.clientWidth / 2 - (e.gamma / 90) * (canvas.clientWidth / 2) * 2;
                    mouse.y =
                        canvas.clientHeight / 2 - (e.beta / 90) * (canvas.clientHeight / 2) * 2;
